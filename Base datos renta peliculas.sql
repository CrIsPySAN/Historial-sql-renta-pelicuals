--Creacion de tablas con Primary key y Forean key
...
--Insertando datos a tablas, eliminado datos y haciendo consulta de datos
...
--Añadiendo modificaciones a las tablas y haciendo actualizaciones
